...
// Tambah Nomor Kamar
document
  .getElementById("add-room-number-btn")
  .addEventListener("click", openRoomNumberModal);
document
  ...
  .addEventListener("click", () => {
    ...
    db.collection("roomNumbers")
      ...
      `;
        ...
        document.querySelectorAll(".edit-room-number-btn").forEach((btn) =>
        ...
        document.querySelectorAll(".delete-room-number-btn").forEach((btn) =>
          btn.addEventListener("click", (e) => {
            const id = e.target.dataset.id;
            deleteRoomNumber(id);
          })
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      db.collection("roomNumbers")
        ...
        .delete()
        .then(() => {
          Swal.fire("Terhapus!", "Nomor kamar berhasil dihapus.", "success");
          closeDetailRoomNumberModal();
        });
    }
  });
